    ...
    Box(
        ...
        Row(
            ...
            Column(
                ...
                Text(
                    text = "Ingeniería en Tecnonolgías Computacionales",
                    style = TextStyle(
                        fontSize = 16.sp,
            ...
            horizontalArrangement = Arrangement.Center)
        {
            Column(
                ...
                Row {
                    Image(
                        painter = painterResource(R.drawable.baseline_add_call_24),
                ...
                Row {
                    Image(
                        painter = painterResource(R.drawable.baseline_attach_email),
                        contentDescription = "Android Icon",
                        modifier = Modifier.padding(end = 20.dp, bottom = 9.dp)
                    )
                }
